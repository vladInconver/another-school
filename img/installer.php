...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20220518_school_8624f9ea6935926e7478_20220518235432_archive.zip';
	const ARCHIVE_SIZE		 = '17545509';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '8624f9e-18235432';
    const SECONDARY_PACKAGE_HASH = 'c314e2f-18235432';
	const VERSION			 = '1.4.5';
